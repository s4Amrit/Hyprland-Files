...
hl.window_rule({ tag = "browser", match = { initial_class = "zen" } })
...
hl.window_rule({ tag = "gamestore", match = { initial_class = "heroic" } })
...
-- Special behaviors
hl.window_rule({
    match = { class = "^(es-de)$" },   -- or initialClass
...
hl.window_rule({
    opacity = "0.9 0.9",
    match = { class = "gnome-disks|org.gnome.DiskUtility" }
})
...
hl.window_rule({
    opacity = "0.9 0.9",
    match = { class = "net.lutris.Lutris|lutris"}
})
...
hl.window_rule({
    opacity = "0.9 0.9",
    match = { class = "YACReader|YACReaderLibrary|com.yacreader.YACReader" }
})
